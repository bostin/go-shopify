...
func TestDraftOrderGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/994118539.json", client.pathPrefix),
...
func TestDraftOrderCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/draft_orders.json", client.pathPrefix),
...
func TestDraftOrderUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1.json", client.pathPrefix),
...
func TestDraftOrderCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 7}`))

	params := map[string]string{"status": "open"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders/count.json", client.pathPrefix),
		params,
...
func TestDraftOrderList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders.json", client.pathPrefix),
...
func TestDraftOrderListOptions(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders.json", client.pathPrefix),
		params,
		httpmock.NewBytesResponder(200, loadFixture("draft_orders.json")))
...
func TestDraftOrderInvoice(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"POST",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/send_invoice.json", client.pathPrefix),
...
func TestDraftOrderDelete(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"DELETE",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1.json", client.pathPrefix),
...
func TestDraftOrderComplete(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"PUT",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/complete.json", client.pathPrefix),
		params,
		httpmock.NewBytesResponder(200, loadFixture("draft_order.json")))
...
func TestDraftOrderListMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields.json", client.pathPrefix),
...
func TestDraftOrderCountMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields/count.json", client.pathPrefix),
		params,
		httpmock.NewStringResponder(200, `{"count": 2}`))
...
func TestDraftOrderGetMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields/2.json", client.pathPrefix),
...
func TestDraftOrderCreateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields.json", client.pathPrefix),
...
func TestDraftOrderUpdateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields/2.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("metafield.json")))
...
func TestDraftOrderDeleteMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/draft_orders/1/metafields/2.json", client.pathPrefix),
