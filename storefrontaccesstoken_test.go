...
func TestStorefrontAccessTokenList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/storefront_access_tokens.json", client.pathPrefix),
...
func TestStorefrontAccessTokenCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/storefront_access_tokens.json", client.pathPrefix),
...
func TestStorefrontAccessTokenDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/storefront_access_tokens/755357713.json", client.pathPrefix),
