...
func TestSmartCollectionList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/smart_collections.json", client.pathPrefix),
...
func TestSmartCollectionCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/smart_collections/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 5}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/smart_collections/count.json", client.pathPrefix),
		params,
...
func TestSmartCollectionGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/smart_collections/1.json", client.pathPrefix),
...
func TestSmartCollectionCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/smart_collections.json", client.pathPrefix),
...
func TestSmartCollectionUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/smart_collections/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("smartcollection.json")))
...
func TestSmartCollectionDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/smart_collections/1.json", client.pathPrefix),
