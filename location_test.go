...
func TestLocationServiceOp_List(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/locations.json", client.pathPrefix),
...
func TestLocationServiceOp_Get(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/locations/4688969785.json", client.pathPrefix),
...
func TestLocationServiceOp_Count(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/locations/count.json", client.pathPrefix),
