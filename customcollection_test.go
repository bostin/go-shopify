...
func TestCustomCollectionList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/custom_collections.json", client.pathPrefix),
...
func TestCustomCollectionCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/custom_collections/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 5}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/custom_collections/count.json", client.pathPrefix),
		params,
...
func TestCustomCollectionGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/custom_collections/1.json", client.pathPrefix),
...
func TestCustomCollectionCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/custom_collections.json", client.pathPrefix),
...
func TestCustomCollectionUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/custom_collections/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("customcollection.json")))
...
func TestCustomCollectionDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/custom_collections/1.json", client.pathPrefix),
...
func TestCustomCollectionListMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields.json", client.pathPrefix),
...
func TestCustomCollectionCountMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields/count.json", client.pathPrefix),
		params,
		httpmock.NewStringResponder(200, `{"count": 2}`))
...
func TestCustomCollectionGetMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields/2.json", client.pathPrefix),
...
func TestCustomCollectionCreateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields.json", client.pathPrefix),
...
func TestCustomCollectionUpdateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields/2.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("metafield.json")))
...
func TestCustomCollectionDeleteMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/collections/1/metafields/2.json", client.pathPrefix),
		httpmock.NewStringResponder(200, "{}"))
