...
func TestThemeList(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/themes.json", client.pathPrefix),
...
func TestThemeGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET",
		fmt.Sprintf("https://"+testHost+"/%s/%s/1.json", client.pathPrefix, themesBasePath),
...
func TestThemeCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST",
		fmt.Sprintf("https://"+testHost+"/%s/%s.json", client.pathPrefix, themesBasePath),
		httpmock.NewBytesResponder(200, loadFixture("theme.json")))
