...
func TestTransactionList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/orders/1/transactions.json", client.pathPrefix),
...
func TestTransactionCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/orders/1/transactions/count.json", client.pathPrefix),
...
func TestTransactionGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/orders/1/transactions/1.json", client.pathPrefix),
...
func TestTransactionCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/orders/1/transactions.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("transaction.json")))
