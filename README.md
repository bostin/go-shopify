...
[![Build Status](https://travis-ci.org/bostin/go-shopify.svg?branch=master)](https://travis-ci.org/bostin/go-shopify)
[![codecov](https://codecov.io/gh/bostin/go-shopify/branch/master/graph/badge.svg)](https://codecov.io/gh/bostin/go-shopify) [![Join the chat at https://gitter.im/bostin/go-shopify](https://badges.gitter.im/bostin/go-shopify.svg)](https://gitter.im/bostin/go-shopify?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
```console
$ go get github.com/bostin/go-shopify
```

## Use

```go
import "github.com/bostin/go-shopify"
```
...
pass in the built in options or create your own and manipulate the client. See [options.go](https://github.com/bostin/go-shopify/blob/master/options.go)
for more details.
