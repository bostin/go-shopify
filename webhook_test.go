...
func TestWebhookList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/webhooks.json", client.pathPrefix),
...
func TestWebhookGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/webhooks/4759306.json", client.pathPrefix),
...
func TestWebhookCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/webhooks/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 7}`))

	params := map[string]string{"topic": "orders/paid"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/webhooks/count.json", client.pathPrefix),
		params,
...
func TestWebhookCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/webhooks.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("webhook.json")))
...
func TestWebhookUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/webhooks/4759306.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("webhook.json")))
...
func TestWebhookDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/webhooks/4759306.json", client.pathPrefix),
