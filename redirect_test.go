...
func TestRedirectList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/redirects.json", client.pathPrefix),
...
func TestRedirectCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/redirects/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/redirects/count.json", client.pathPrefix),
		params,
...
func TestRedirectGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/redirects/1.json", client.pathPrefix),
...
func TestRedirectCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/redirects.json", client.pathPrefix),
...
func TestRedirectUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/redirects/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("redirect.json")))
...
func TestRedirectDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/redirects/1.json", client.pathPrefix),
