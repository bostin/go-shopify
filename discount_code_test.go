...
func TestDiscountCodeList(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/price_rules/507328175/discount_codes.json", client.pathPrefix),
...
func TestDiscountCodeGet(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/price_rules/507328175/discount_codes/507328175.json", client.pathPrefix),
		httpmock.NewStringResponder(
			200,
...
func TestDiscountCodeUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"PUT",
		fmt.Sprintf("https://"+testHost+"/%s/price_rules/507328175/discount_codes/1054381139.json", client.pathPrefix),
		httpmock.NewBytesResponder(
			200,
			loadFixture("discount_code.json"),
		),
...
func TestDiscountCodeDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/price_rules/507328175/discount_codes/507328175.json", client.pathPrefix),
