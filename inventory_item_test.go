...
func TestInventoryItemsList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/inventory_items.json", client.pathPrefix),
...
func TestInventoryItemsListWithIDs(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/inventory_items.json", client.pathPrefix),
		params,
		httpmock.NewBytesResponder(200, loadFixture("inventory_items.json")),
	)
...
func TestInventoryItemGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/inventory_items/1.json", client.pathPrefix),
...
func TestInventoryItemUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/inventory_items/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("inventory_item.json")))
