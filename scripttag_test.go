...
func TestScriptTagList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/script_tags.json", client.pathPrefix),
...
func TestScriptTagCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/script_tags/count.json", client.pathPrefix),
...
func TestScriptTagGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/script_tags/1.json", client.pathPrefix),
...
func TestScriptTagCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/script_tags.json", client.pathPrefix),
...
func TestScriptTagUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/script_tags/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("script_tags.json")))
...
func TestScriptTagDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/script_tags/1.json", client.pathPrefix),
