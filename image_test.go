...
func TestImageList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/products/1/images.json", client.pathPrefix),
...
func TestImageCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/products/1/images/count.json", client.pathPrefix),
		httpmock.NewStringResponder(200, `{"count": 2}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://"+testHost+"/%s/products/1/images/count.json", client.pathPrefix),
		params,
...
func TestImageGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://"+testHost+"/%s/products/1/images/1.json", client.pathPrefix),
...
func TestImageCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://"+testHost+"/%s/products/1/images.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("image.json")))
...
func TestImageUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://"+testHost+"/%s/products/1/images/1.json", client.pathPrefix),
		httpmock.NewBytesResponder(200, loadFixture("image.json")))
...
func TestImageDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://"+testHost+"/%s/products/1/images/1.json", client.pathPrefix),
